<template>
  <div class="settings-page">
    ...
    <!-- 授权信息栏 -->
    <div v-if="licenseInfo" class="license-info-bar">
      <div class="license-info-item">
        <span class="license-info-label">激活码</span>
        <span class="license-info-value code">{{ licenseInfo.activationCode || '-' }}</span>
      </div>
      <div class="system-info-divider"></div>
      <div class="license-info-item">
        <span class="license-info-label">授权状态</span>
        <el-tag :type="getLicenseStatus().type" size="mini">{{ getLicenseStatus().text }}</el-tag>
      </div>
      <div class="system-info-divider"></div>
      <div class="license-info-item">
        <span class="license-info-label">过期时间</span>
        <span class="license-info-value">{{ formatLicenseDate(licenseInfo.expiresAt) }}</span>
      </div>
    </div>
...
export default {
  ...
  created() {
    ...
    if (session && session.licenseInfo) {
      this.licenseInfo = session.licenseInfo
    }
  },
  methods: {
    goTo(group) {
