...
public class OpenDataController {
     ...
     */
    private boolean validateClinicId(HttpServletRequest request, String pathClinicId) {
        Object attr = request.getAttribute("apiKeyClinicId");
        if (attr == null) {
            return false;
        }
        return attr.toString().equals(pathClinicId);
    }
    ...
    public Result getBusinessStats(
            @Parameter(description = "诊所ID", required = true) @PathVariable("clinicId") String clinicId,
    ...
    public Result getPatientsWorkbench(@PathVariable("clinicId") String clinicId,
    ...
    public Result getConsultationFollowups(@PathVariable("clinicId") String clinicId,
    ...
    public Result getPatientGroups(@PathVariable("clinicId") String clinicId,
                                   @RequestParam(required = false) String keyword,
                                   @RequestParam(defaultValue = "1") int page,
                                   @RequestParam(defaultValue = "10") int size,
                                   HttpServletRequest request) {
    ...
    public Result getPatientImages(@PathVariable("clinicId") String clinicId,
                                   @PathVariable("id") Long id,
                                   HttpServletRequest request) {
        if (!validateClinicId(request, clinicId)) {
            return Result.error("403", "无权访问该诊所数据");
