...
public class InventoryService {
     ...
     * @param brand 品牌
     * @param supplier 供应商
     * @param keyword 关键词（匹配产品名、分类、品牌）
     * @return 库存列表
     */
    public List<Inventory> searchInventory(String category, String brand, String supplier, String keyword) {
        return inventoryMapper.searchInventory(category, brand, supplier, keyword);
    }
