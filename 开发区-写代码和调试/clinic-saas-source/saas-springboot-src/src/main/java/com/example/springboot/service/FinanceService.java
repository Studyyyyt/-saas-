...
public class FinanceService {
     ...
     * @return 财务记录列表
     */
    public List<Finance> searchFinances(String recordType, String startDate, String endDate, Long patientId, String keyword) {
        return financeMapper.searchFinances(recordType, startDate, endDate, patientId, keyword);
    }
