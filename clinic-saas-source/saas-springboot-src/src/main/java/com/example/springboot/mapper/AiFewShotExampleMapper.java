...
public interface AiFewShotExampleMapper {
    ...
    @Select("SELECT id, template_id, input_content, output_content, sort_order, create_time FROM ai_few_shot_example WHERE template_id = #{templateId} ORDER BY sort_order, id")
