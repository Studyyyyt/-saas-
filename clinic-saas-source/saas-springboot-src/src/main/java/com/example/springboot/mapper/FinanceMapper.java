...
public interface FinanceMapper {
    ...
    @Select("<script>" +
            ...
            "<where>" +
            "  <if test='recordType != null and recordType != \"\"'>AND type = #{recordType}</if>" +
            "  <if test='startDate != null and startDate != \"\"'>AND date &gt;= #{startDate}</if>" +
            ...
            "</script>")
    List<Finance> searchFinances(@Param("recordType") String recordType,
