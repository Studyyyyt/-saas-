...
class MedicalRecordServiceToothPositionTest {
    ...
    static class StubMedicalRecordMapper implements MedicalRecordMapper {
        ...
        @Override public List<MedicalRecord> selectAllWithFilter(Long doctorAccountId, String recordStatus, String startDate, String endDate, String keyword) { return Collections.emptyList(); }
