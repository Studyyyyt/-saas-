...
export const ROLE_MENU_CATALOG = [
  ...
  { key: '/MedicalRecord', label: '病历工作台', group: '通用', defaultRoles: ['admin', 'doctor', 'nurse'] },
  ...
  { key: '/SystemTreatmentCatalog', label: '项目库', group: '系统设置', defaultRoles: ['admin', 'nurse'] },
  { key: '/SystemTreatmentOperation', label: '操作字典', group: '系统设置', defaultRoles: ['admin', 'nurse'] },
